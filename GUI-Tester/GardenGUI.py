...
def configureTemp():
    ...
    if tempConfigOpen == False:
        ...
        ttk.Label(tempConfigWindow, text='Configure Temperature',font=("areil", 13)).pack(pady=5)
        ttk.Label(tempConfigWindow, text = str(minTempValue))
...
def maxHumEntryCommand(maxHumEntryCommands):
    ...
    if maxHumEntryInt > 40:
        maxHumEntryInt = 40
    elif maxHumEntryInt < 5:
        maxHumEntryInt = 5
...
def minHumEntryCommand(minHumEntryCommands):
    ...
    if minHumEntryInt > 40:
        minHumEntryInt = 40
    elif minHumEntryInt < 5:
        minHumEntryInt = 5
...
def configureHum():
    ...
    if humConfigOpen == False:
        ...
        ttk.Label(humConfigWindow, text='Configure Humerature',font=("areil", 13)).pack(pady=5)
        ttk.Label(humConfigWindow, text = str(minHumValue))
...
def saveOptimalMoistureConfig():
    ...
    soilConfigOpen = False
    gardenOne.modOptimalMoisture(optimalMoisture)
...
def configureSoilMoisture():
    ...
    if soilConfigOpen == False:
        ...
        ttk.Label(moistureConfigWindow, text='Configure Optimal Moisture',font=("areil", 13)).pack(pady=5)
        ttk.Label(moistureConfigWindow, text = str(optimalMoisture))
...
btnConfigTemp = ttk.Button(temperatureFrame, text = 'Configure', command = configureTemp)
...
currentTempLabel = ttk.Label(temperatureFrame, text = "Current Temp: ", font = ("aerial", 10))
...
btnConfigHum = ttk.Button(humidityFrame, text = 'Configure', command = configureHum)
currentHumLabel = ttk.Label(humidityFrame, text = 'Current Hmd: ', font = ('aerial', 10))

soilMoistureFrame = tk.LabelFrame(root, text = 'Soil Moisture', labelanchor = 'n', relief='sunken', width = 150, height = 205)
